...
paqueterias = {
    "Estafeta": cargar_excel("COBERTURA_ESTAFETA.xlsx","Hoja1"),
    "Paquete_Express": cargar_excel("COBERTURA_PAQUETEXPRESS.xlsx", "Hoja1"),
    "JyT": cargar_excel("COBERTURA_J&T.xlsx", "Hoja1"),
    "Almex": cargar_excel("COBERTURA_ALMEX.xlsx", "Hoja1"),
    "PMM": cargar_excel("COBERTURA_PMM.xlsx","Hoja1")
}
